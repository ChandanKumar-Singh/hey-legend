...
import 'package:hey_legend/Screens/DashBoard/DashBoardItems/widget_json.dart';

class MyHomePage extends StatefulWidget {
  MyHomePage({Key? key, this.title = 'Dynamic'}) : super(key: key);
...
//
//
// class BuildAutomaticWidget extends StatefulWidget {
//   const BuildAutomaticWidget({Key? key}) : super(key: key);
//
//   @override
//   State<BuildAutomaticWidget> createState() => _BuildAutomaticWidgetState();
// }
//
// class _BuildAutomaticWidgetState extends State<BuildAutomaticWidget> {
//   @override
//   Widget build(BuildContext context) {
//     return Scaffold(
//       appBar: AppBar(title: Text('BuildAutomaticWidget'),centerTitle: true,),
//         body: generated.,
//     );
//   }
// }
